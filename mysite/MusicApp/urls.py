...
urlpatterns = [
	...
	url(r'^playlists/add/$', views.add_to_playlist, name="add_to_playlist"),
	url(r'^playlists/(?P<username>[a-zA-Z0-9]{1,})/view$',views.view_user_playlists, name="view_user_playlists"),
	url(r'^playlists/(?P<username>[a-zA-Z0-9]{1,})/view/$',views.view_user_playlists, name="view_user_playlists"),
	...
	url(r'^playlists/(?P<username>[a-zA-Z0-9]{1,})/import/(?P<name>[a-zA-Z]{1,})$', views.import_playlist, name="import_playlist"),
	url(r'^playlists/(?P<username>[a-zA-Z0-9]{1,})/import/(?P<name>[a-zA-Z]{1,})/$', views.import_playlist, name="import_playlist"),
