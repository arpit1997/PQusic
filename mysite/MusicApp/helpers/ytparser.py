...
class YtParser:
	...
	def get_thumbnail(self):
		thumb_nail = self.page.find_all('div', {'class':'yt-thumb video-thumb'})
		for thumbs in thumb_nail:
			self.yt_links_thumbs.append(thumbs.find_all('span',{'class':'yt-thumb-simple'})[0].find_all('img')[0].get('src'))
